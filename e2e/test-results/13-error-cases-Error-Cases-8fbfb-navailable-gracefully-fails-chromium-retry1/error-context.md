...
- Name: 13-error-cases.spec.ts >> Error Cases and Edge Cases >> API error handling - backend unavailable gracefully fails
- Location: tests/13-error-cases.spec.ts:38:7
